...
| [`gtm-seven-part-research-zh`](skills/gtm-seven-part-research-zh/SKILL.md) | 中文版七步 GTM 调研：用户洞察、产品设计、品牌定位（含完整竞品扫描）、内容策略、营销渠道、转化策略、路径优化，以真实数据支撑，产出带样式的自包含 HTML 报告和补充 Markdown 报告，全部为中文。Use for any new product, idea, or client GTM when a Chinese-language research report is wanted. |
| [`gtm-seven-part-research-d2c`](skills/gtm-seven-part-research-d2c/SKILL.md) | The e-commerce D2C version of the seven-part GTM research, for physical consumer products and brands: user insight from Amazon, TikTok, and Reddit, hero SKU and offer design with unit economics (contribution margin, break-even CAC and ROAS), brand positioning with a competitor sweep across storefronts, Amazon, and the Meta Ad Library, a UGC and creator content system, one paid or creator channel with a test budget, product page conversion, and repeat purchase as the north star. Ends in a styled HTML report plus a supplemental Markdown report. |
| [`gtm-seven-part-research-d2c-zh`](skills/gtm-seven-part-research-d2c-zh/SKILL.md) | 中文版电商 D2C 七步 GTM 调研：用户洞察、产品与报价设计（含单位经济：边际贡献、盈亏平衡 CAC 和 ROAS）、品牌定位（覆盖独立站、Amazon 和 Meta 广告库的竞品扫描）、UGC 与达人内容体系、单一付费或达人渠道、详情页转化，以复购为北极星指标；目标市场为中国大陆时切换到天猫、京东、小红书、抖音和微信私域。产出带样式的自包含 HTML 报告和补充 Markdown 报告，全部为中文。Use for any D2C brand GTM when a Chinese-language report is wanted. |
