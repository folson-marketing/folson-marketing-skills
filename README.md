...
| [`gtm-seven-part-research-d2c-zh`](skills/gtm-seven-part-research-d2c-zh/SKILL.md) | 中文版电商 D2C 七步 GTM 调研：用户洞察、产品与报价设计（含单位经济：边际贡献、盈亏平衡 CAC 和 ROAS）、品牌定位（覆盖独立站、Amazon 和 Meta 广告库的竞品扫描）、UGC 与达人内容体系、单一付费或达人渠道、详情页转化，以复购为北极星指标，面向美国等海外市场。产出带样式的自包含 HTML 报告和补充 Markdown 报告，全部为中文。Use for any D2C brand GTM when a Chinese-language report is wanted. |
