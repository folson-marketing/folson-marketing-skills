---
name: gtm-six-step-research
description: "Run a data-backed GTM analysis using Frank's six-step framework (Total Market, Segmentation, Positioning, Core Message, One Channel, Monitor & Iteration) with Apify MCP research, a full competitor sweep, and a final report. Use for any new product, idea, or client GTM."
---
